            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/attendance') }}" method="POST">
                        @csrf
                        <label for="attend" class="form-label">Select Your Attendance</label>
                        <div class="select_gender">
                            <input type="radio" name="attend" id="present" value="present">
                            <label for="present" style="padding-right: 20px;"> Present</label>
                            <input type="radio" name="attend" id="absent" value="absent">
