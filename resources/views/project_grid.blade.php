                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">New admin
                                            Design</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Brand logo
                                            design</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">New Landing
                                            Design</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Redesign -
                                            Landing page</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Awsome
                                            Dashboard UI</a></h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Blog Template
                                            UI</a></h5>
                                    <p class="text-muted mb-4"> For science, music, sport, etc</p>
                                    <div class="team">
                                        <a href="javascript: void(0);" class="team-member d-inline-block"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">App Landing
                                            UI</a></h5>
                                    <p class="text-muted mb-4">To achieve it would be necessary</p>
                                    <div class="team">
                                        <div class="team">
